  ...
  <div class="row">
    ...
    <div class="col-md-8 wow bounceInRight" data-wow-delay="0.1">
      ...
      <div class="row d-flex">
        ...
        <div class="col-md-5">
          <h4>Form Áo</h4>
          <button class="btn btn-danger mb-2">Áo Bếp Trưởng</button>
          <button class="btn btn-danger mb-2">Áo Bếp Phó</button>
        </div>
      </div>
      <hr>
    ...
    <div class="col-md-12">
      ...
      <div class="tab-content" id="nav-tabContent">
        <div class="tab-pane fade show active px-4 pt-4" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
          <!-- Chi Tie Tin -->
          <h4>Đồng Phục Thành Công chuyên sản xuất và May Đồng Phục Bếp, Áo Đầu Bếp, Áo Bếp Trưởng, Tạp Dề Bếp đảm báo
            uy tín, chất lượng giá rẻ.</h4>
          ...
          <span>Đồng phục cho đầu Bếp</span> là loại đồng phục không thể thiếu đối với mỗi nhà hàng khách sạn, quán ăn
          hay ít nhất là trong mỗi gia đình chúng ta vì thế đồng phục cho đầu bếp là yếu tố làm nên đặc trưng nhận dạng
          thương hiệu cho Nhà hàng, khách sạn hay quán chúng ta ví dụ như:
          <ul class="list-group list-group-flush mt-2">
            <li class="list-group-item"> <b>• Tác phong chuyên nghiệp:</b> Với đồng phục tạp dề khách hàng thấy được sự
              chu đáo, vệ sinh, cũng như tác phong phục vụ khách hàng rất là nghiêm túc.</li>
            ...
            <li class="list-group-item"><b>• Tính thẩm mỹ:</b> Đồng phục cho Quán Cafe hay Nhà hàng mang tính thẩm mỹ
              cao, bởi sự đơn giản
              nhưng vẫn đảm bảo sang trọng, chỉn chu và thanh lịch.</li>
          </ul> <br>
          Với những lý do tuyệt vời mà đồng phục Bếp đẹp mang lại thì đây đúng là sự lựa chọn tuyệt vời cho nhân
          viên của nhà hàng. Chần chờ gì mà không may đồng phục sơ mi ngay hôm nay nhận được những giá trị mà đồng phục
          mang
          lại. <br>
          <h4 class="mt-2">
            Những vấn đề cần lưu ý để sở hữu mẫu Đồng Phục Cho Đầu Bếp Nhà hàng, Quán cafe đó là về Chất Liệu Vải.
          </h4>
          ...
          <h4 class="mt-2">
            Chọn được loại Chất Liệu vải thích hợp cho đồng phục Quán và phù hợp với nhu cầu thực tiễn và giá thành hợp
            lý.
          </h4>
    ...
    <div class="row justify-content-center  wow bounceInLeft" data-wow-delay="0.1">
      <div class="col-md-8">
        <div class="section-heading text-center mb-4">
          <h2>Mẫu Đồng Phục <span>Cho Đầu Bếp</span></h2>
        </div>
        <hr>
      </div>
    </div>
        ...
        <div class="item">
          <div class="single-product rounded border single-promo-hover">
            <a href="<?php the_permalink();?>">
              <img src="<?php the_post_thumbnail_url();?>" class="img-fluid" alt="mẫu áo bếp đẹp" />
            </a>
