  ...
  <div class="tinto">
    ...
    <div class="row">
      ...
      <a href="<?php the_permalink(); ?>">
          <img src="<?php the_post_thumbnail_url();?>" alt="Công ty may đồng phục sơ mi giá rẻ tại tp hcm" class="img-responsive w-100 rounded-sm rounded img-thumbnail">
        </a>
      </div>
