...
<?php
  $tinso1 = new WP_Query(array(
    'post_type'=> 'post',
    'category_name'=>'dong-phuc-bao-ho-lao-dong',
    // 'posts_per_page'=> 1
  ));
?>
  ...
  <div class="tinto">
    ...
    <div class="row">
      ...
      <a href="<?php the_permalink(); ?>">
          <img src="<?php the_post_thumbnail_url();?>" alt="Công ty may đồng phục bảo hộ lao động giá rẻ tại tp hcm" class="img-responsive w-100 rounded-sm rounded img-thumbnail">
        </a>
      </div>
